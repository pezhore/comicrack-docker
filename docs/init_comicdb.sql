...
CREATE USER 'comicrack'@'%' IDENTIFIED BY 'comicrack';
GRANT ALL PRIVILEGES ON * . * to 'comicrack'@'%';
FLUSH PRIVILEGES;
...
CREATE TABLE `changes` (
  ...
  `update_counter` bigint(20) DEFAULT 0,
  `delete_counter` bigint(20) DEFAULT 0,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2023-11-10 23:41:42
